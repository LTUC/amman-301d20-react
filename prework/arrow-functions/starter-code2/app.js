...
// you will want to avoid using an arrow function in a constructor (where we need the contextual this to be the object we are building)
//  or any method that needs to use this to behave properly
